...
namespace PithFront\PithPackBootstrap;

use Pith\Workflow\PithRoute;

/**
 * Class BootstrapResourceRoute
 */
class BootstrapResourceRoute extends PithRoute
{
    public string $pack            = 'PithFront\\PithPackBootstrap\\BootstrapResourcePack';
